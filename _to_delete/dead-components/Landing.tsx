...
import PhoneIconImage from "@/public/images/phone-icon.png"; // Rinomina per chiarezza
...
export default function WatchMe() {
  ...
  return (
    <main className="dark:bg-gray-800 bg-white relative overflow-hidden h-screen">
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-20 bg-gray-900 bg-opacity-75 flex items-center justify-center">
          <nav className="flex flex-col text-white uppercase text-xl text-center">
