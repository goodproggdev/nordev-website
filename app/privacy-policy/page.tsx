export default function PrivacyPolicyPage() {
	return (
		<div className="container mx-auto px-4 py-16">
			<h1 className="text-3xl font-bold mb-8">Privacy Policy for Nordev</h1>
			<div className="prose max-w-none">
				<p><strong>Last updated:</strong> September 02, 2025</p>
				...
				<ul>
					...
					<li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nordev.</li>
					...
					<li><strong>Website</strong> refers to Nordev, accessible from <a href="http://www.nordev.it">http://www.nordev.it</a></li>
				...
				<ul>
					...
					<li>For other purposes such as data analysis and improving services</li>
				</ul>

				<p>We may share Your personal information in the following situations: with Service Providers, for business transfers, with Affiliates, with business partners, with other users, with Your consent.</p>

				<h3>Retention of Your Personal Data</h3>
				<p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to comply with legal obligations, resolve disputes, and enforce agreements.</p>

				<h3>Transfer of Your Personal Data</h3>
				<p>Your information may be transferred to computers located outside of Your state, province, or country. Your consent to this Privacy Policy represents Your agreement to that transfer.</p>

				<h3>Delete Your Personal Data</h3>
				<p>You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You. Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
				...
				<p>The Company may disclose Your Personal Data in good faith belief that such action is necessary to comply with a legal obligation, protect and defend the rights or property of the Company, prevent or investigate wrongdoing, protect users or the public, protect against legal liability.</p>
				...
				<ul>
					<li>By email: info@nordevit.it</li>
				</ul>
			</div>
		</div>
	)
